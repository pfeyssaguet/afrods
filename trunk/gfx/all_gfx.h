...
extern const unsigned char spr_menu_Sprite[12288] __attribute__((aligned (4))); // Palette: palMenu_Pal
...
extern const int bg_menu_bottom_Info[3] __attribute__((aligned (4))); // BgMode, Width, Height
extern const unsigned int bg_menu_bottom_Map[768] __attribute__((aligned (4))); // Palette: bg_menu_bottom_Pal
extern const unsigned char bg_menu_bottom_Tiles[49152] __attribute__((aligned (4))); // Palette: bg_menu_bottom_Pal
...
extern const unsigned short bg_menu_bottom_Pal[256] __attribute__((aligned (4)));
